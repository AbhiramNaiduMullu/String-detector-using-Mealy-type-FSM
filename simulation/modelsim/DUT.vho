...
SIGNAL \dut_instance|add_instance|y_present.init~regout\ : std_logic;
...
\dut_instance|add_instance|y_present.init\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|y_present.init~regout\ = DFFEAS((!\dut_instance|add_instance|outp~0\ & (!dut_input(1) & ((\dut_instance|add_instance|Equal0~0_combout\) # (\dut_instance|add_instance|y_present.init~regout\)))), GLOBAL(dut_input(0)), VCC, , , , , 
-- , )
...
PORT MAP (
	...
	datac => \dut_instance|add_instance|y_present.init~regout\,
	datad => dut_input(1),
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \dut_instance|add_instance|y_present.init~regout\);
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.s1~regout\ = DFFEAS((!dut_input(1) & ((\dut_instance|add_instance|y_present~13_combout\) # ((\dut_instance|add_instance|Equal0~0_combout\ & !\dut_instance|add_instance|y_present.init~regout\)))), GLOBAL(dut_input(0)), 
-- VCC, , , , , , )
